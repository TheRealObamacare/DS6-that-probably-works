...
public class DS6_PriorityQueue_Tests {
    ...
    String[] toStrings = {"[1, 2, 5, 5, 5, 10, 11, 16, 16, 18, 21, 26, 28]",
            "[1, 2, 2, 6, 7, 8, 13, 14, 18, 18, 19, 24]",
            "[6, 8, 14, 20, 20, 21, 21, 21, 29, 30]",
            "[11, 13, 15, 17, 20, 20]",
            "[1, 2, 4, 5, 13, 14, 16, 25]",
            "[4, 8, 9, 17, 21, 23, 29]",
            "[2, 4, 4, 12, 13, 16, 16, 22, 23, 25, 27, 27]",
            "[3, 7, 14, 24, 25, 27, 30]",
            "[4, 5, 6, 11, 14, 14, 21, 25, 26, 29]",
            "[1, 4, 7, 9, 11, 11, 14, 21, 21, 22, 23, 25]",
            "[3, 5, 6, 7, 14, 15, 16, 18, 21, 23, 28]",
            "[5, 9, 10, 12, 16, 18, 21, 26, 30]",
            "[6, 16, 19, 26, 26, 29, 30]",
            "[2, 3, 6, 8, 14, 15, 18, 24, 27, 28, 29]",
            "[2, 2, 3, 3, 6, 8, 8, 11, 11, 12, 14, 23]",
            "[5, 16, 17, 17, 21, 24, 27, 28]",
            "[1, 4, 5, 7, 9, 11, 14, 15, 22, 23, 24, 30]",
            "[10, 13, 24, 24, 26, 27]",
            "[1, 2, 2, 8, 10, 11, 13, 15, 17, 19, 22]",
            "[2, 3, 6, 7, 9, 9, 12, 15, 18, 22, 27, 28, 29]"};
    ...
    String[] removeToStrings = {"[21, 26, 28]",
            "[6, 7, 8, 13, 14, 18, 18, 19, 24]",
            "[20, 21, 21, 21, 29, 30]",
            "[13, 15, 17, 20, 20]",
            "[1, 2, 4, 5, 13, 14, 16, 25]",
            "[9, 17, 21, 23, 29]",
            "[4, 12, 13, 16, 16, 22, 23, 25, 27, 27]",
            "[24, 25, 27, 30]",
            "[14, 14, 21, 25, 26, 29]",
            "[11, 11, 14, 21, 21, 22, 23, 25]",
            "[18, 21, 23, 28]",
            "[21, 26, 30]",
            "[16, 19, 26, 26, 29, 30]",
            "[28, 29]",
    ...
    public void test2() throws Exception {
        try
        {
            ...
            Assert.assertEquals("jack",get.invoke(check,1));
            Assert.assertEquals("tina",get.invoke(check,2));
